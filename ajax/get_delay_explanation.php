...
if ( $mode == 0 )
{
  $query0 = mysql_query("SELECT ID, STATUS, supervisorID, explaneDesk FROM Delays where date = '$currentDate' and userID = '$userID_'"); 
}
else
{
  $query0 = mysql_query("SELECT STATUS, supervisorID, explaneDesk FROM Delays where ID = '$delayID' and userID = '$userID'"); 
}
