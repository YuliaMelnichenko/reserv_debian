...
else
{
  ...
  {  
    ...
    echo "<td class=\"add_time\" width = 270 valign=\"middle\" align=\"left\">"."<h5 class=\"middle\">$userName</h5>"."</td>";
    ...
    echo "<td class=\"add_time\" width = 105 valign=\"middle\" align=\"center\">";
      echo "<button id = \"explBtn\" title = \"Просмотреть\" style=\"padding: 0px 0px 0px 0px; background-color:#ffffff; border:0px solid #888888;\" onclick=\"show_add_times_by_user( '$userID' );\"><img src=\"img/$img\"></button>";
    echo "</td>";
    echo "</tr>";
