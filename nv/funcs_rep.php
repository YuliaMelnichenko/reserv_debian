...
function get_report_body_row_contents( $usersInfo )
{
  ...
  foreach ( $usersInfo[7][0][0] as $currentMonthDate )
  {
    ...
    if ( $sufixFound == 0 )
    {
      ...
      $rowDTContent .=     "<table>";
      $rowDTContent .=       "<tr><td height = 75 valign = \"middle\" align = \"center\"><h5>$currentMonthDate</h5></td></tr>";
      $rowDTContent .=       "<tr><td height = 75 valign = \"middle\" align = \"center\"><h5>$currentDayName</h5></td></tr>";
      $rowDTContent .=     "</table>";
      $rowDTContent .=   "</div>"; 
      $rowDTContent .= "</td>";
    }
    else
    {
      ...
      $rowDTContent .=   "<div class=\"report_head_left_date_cert\" id=\"report_head_left_date_cert\">";
      $rowDTContent .=     "<table>";
      $rowDTContent .=       "<tr><td height = 50 valign = \"middle\" align = \"center\"><h5>$currentMonthDate</h5></td></tr>";
      $rowDTContent .=       "<tr><td height = 50 valign = \"middle\" align = \"center\"><h5>$currentDayName</h5></td></tr>";
      $rowDTContent .=       "<tr><td height = 50 valign = \"middle\" align = \"center\"><h5 class=\"smallBlue\">$sufix</h5></td></tr>";
      $rowDTContent .=     "</table>";
      $rowDTContent .=   "</div>"; 
      $rowDTContent .= "</td>";
    } 
