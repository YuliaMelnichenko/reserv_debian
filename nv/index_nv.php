            ...
            echo "<table>";
              echo "<tr>";
                echo "<td class=\"report_no_padding_no_border_no_bg\" bordercolor=\"#888888\" valign=\"middle\" align=\"center\" width = 198px>";
                  echo "<button style=\"font-size: 80%; width:180px; height:30px; background-color:#f8d888; border:1px solid #888888;\" onclick=\"day_continue_confirm();\">Ok</button>";                   
                echo "</td>";
                echo "<td class=\"report_no_padding_no_border_no_bg\" bordercolor=\"#888888\" valign=\"middle\" align=\"center\" width = 198px>";
                  echo "<button style=\"font-size: 80%; width:180px; height:30px; background-color:#f8d888; border:1px solid #888888;\" onclick=\"day_continue_reject();\">Oтмена</button>";                   
                echo "</td>";
              echo "</tr>";
            echo "</table>";
...
//echo "{{{ $currentDate $startDTStr $stopDTStr }}}<br>";
    ...
    echo "<h5 class=\"dark0\"><br>/что нового в версии 2.0:<br><br></h5>";

    echo "<h5 class=\"dark1\">1. возможность задать смещение начала суток для неразрывного учета времени.<br></h5>";
    echo "<h5 class=\"dark1\">2. возможность задать часовой пояс сотрудника.<br></h5>";
    echo "<h5 class=\"dark1\">3. исправлена ошибка занчения времени при переходе на летнее/зимнее время.<br></h5>";
    echo "<h5 class=\"dark1\">4. включение/выключения режима \"удаленная работа\"<br></h5>";
