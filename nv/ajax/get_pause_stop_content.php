...
$query = mysql_query("select ID, SUIR, START_DT, DESCRIPTION from ADD_TIME where ADDDATE = '$currentDate' and USERID = '$userID' and PAUSE_MODE = 1 order by ADDDATE desc, START_DT desc limit 1");
