...
$content .= "<button style=\"font-size: 100%; width:178px; height:25px; background-color:#ff7979; border:1px solid #888888;\" onclick=\"cancel_time_add(); location.reload();\">Закрыть</button><br>";
$content .= "</td>";

$content .= "<td bordercolor=\"#000000\" width=\"520px\" valign=\"middle\" align=\"right\">";
$content .= "<button style=\"font-size: 100%; width:178px; height:25px; background-color:#f8d888; border:1px solid #888888;\" onclick=\"add_addition_time();\">Добавить</button><br>";
$content .= "</td>";
