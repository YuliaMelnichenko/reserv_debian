...
else
{
  ...
  foreach( $newDaysRange as $rDay )
  {
    ...
    $query = mysql_query("insert into ADD_TIME (ID, ADDDATE, USERID, STARTDATE, STOPDATE, STARTTIME, STOPTIME, REASON, DESCRIPTION, APPROVED, PAUSE_MODE, BYALERT ) VALUES ('$newID','$currentDate','$userID_','$rDay','$rDay','$startTimeStr','$stopTimeStr','$add_time_part_base','$add_time_part_desk','0', '0', '$byAlert')");
