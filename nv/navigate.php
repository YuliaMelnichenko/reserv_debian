...
//if ( $_SESSION['ss_id'] != -1 && $_SESSION['ss_id'] != 500 && $_SESSION['ss_id'] != 501 )
{
  ...
  if ( $needToShow == 1 ){ echo "<tr height=50 valign=\"bottom\"><td><button style=\"font-size: 80%; text-align: left; padding: 5px 27px 5px 5px; width:230px; height:40px; background-color:#f8d888; border:1px solid #888888;\" onclick=\"location.href='index.php'\"><h5 class=\"bigger\">Текущий день</h5></button></td></tr>"; }
                           echo "<tr height=50 valign=\"bottom\"><td><button style=\"font-size: 80%; text-align: left; padding: 5px 5px 5px 5px; width:230px; height:40px; background-color:#f8d888; border:1px solid #888888;\" onclick=\"location.href='my_report.php'\"><h5 class=\"bigger\">Временной отчет</h5></button></td></tr>";
  if ( $needToShow == 1 ){ echo "<tr><td><button style=\"font-size: 80%; text-align: left; padding: 5px 0px 5px 5px; width:230px; height:40px; background-color:#a8fd88; border:1px solid #888888;\" onclick=\"location.href='time_add.php'\"><h5 class=\"bigger\">Работа вне офиса</h5></button></td></tr>"; }
  if ( $needToShow == 1 ){ echo "<tr><td><button style=\"font-size: 80%; text-align: left; padding: 5px 0px 5px 5px; width:230px; height:40px; background-color:#a8fd88; border:1px solid #888888;\" onclick=\"location.href='delay.php'\"><h5 class=\"bigger\">Опоздания</h5></button></td></tr>"; }
  if ( $needToShow == 1 ){ echo "<tr><td><button style=\"font-size: 80%; text-align: left; padding: 5px 0px 5px 5px; width:230px; height:40px; background-color:#a8fd88; border:1px solid #888888;\" onclick=\"location.href='pause.php'\"><h5 class=\"bigger\">Приостановки учета времени</h5></button></td></tr>"; }
  ...
  {           
    ...
    echo "<tr><td><button id=\"notifBtn\" style=\"font-size: 80%; text-align: left; padding: 5px 20px 5px 5px; width:230px; height:60px; background-color:#f8d888; border:1px solid #888888;\" onclick=\"add_time_set_start(); location.href='time_approvement.php'\"><h5 class=\"biggersmall\">По работе вне офиса $counterStr</h5></button></td></tr>";
    echo "<tr><td><button id=\"notifDelayBtn\" style=\"font-size: 70%; text-align: left; padding: 5px 5px 5px 5px; width:230px; height:60px; background-color:#f8d888; border:1px solid #888888;\" onclick=\"delay_set_start(); location.href='delay_approvement.php'\"><h5 class=\"biggersmall\">По опозданиям $delayNotifCountStr</h5></button></td></tr>";
    if ( $needToShow == 1 ){ echo "<tr><td><button id=\"notifPauseBtn\" style=\"font-size: 70%; text-align: left; padding: 5px 5px 5px 5px; width:230px; height:60px; background-color:#f8d888; border:1px solid #888888;\" onclick=\"pause_set_start(); location.href='pause_view.php'\"><h5 class=\"biggersmall\">По приостановкам учета времени $pauseNotifCountStr</h5></button></td></tr>"; }
  } 
  echo "<tr><td height=8px></td></tr>";

  echo "<tr><td><button style=\"text-align: left; padding: 5px 25px 5px 10px; width:230px; height:40px; background-color:#f79398; border:1px solid #888888;\" onclick=\"window.open('http://192.168.100.17/my') \"><h5 class=\"bigger\">RedMine</h5></button></td></tr>";
