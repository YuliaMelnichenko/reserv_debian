...
<script type="text/javascript" src="js/index-page.js?v=20260729-lunch-refresh"></script>
...
////////////////////////////////////////////////////////
  ...
  if ( isset( $_SESSION['ss_id'] ) )
  {
    ...
    echo "<div id=\"inform\">";
    echo "<h5 class=\"dark0\"><br>/обновления кнопки 04.08.2026г.:<br><br></h5>";
    echo "<h5 class=\"dark1\">1. Добавлена индикация ошибок учета рядом с ФИО и кнопка «Ошибки учета». Кнопка и индикация появляются тогда, когда у вас нет уважительной причины отсутствия в рабочий день, занесенной во Втори. Уважительные причины: Отпуск, больничный, командировка, запись в работе вне офиса. Для закрытия ошибки учета нужно внести отпуск\больничный\командировку\работу вне офиса. Во вкладке \"Ошибки учета\" можно внести комментарий, объясняющий причину отсутствия, если не было уважительной причины.<br></h5>";
    echo "<h5 class=\"dark1\">2. Исправлено определение опозданий и исключена проверка в выходные.<br></h5>";
    echo "<h5 class=\"dark1\">3. Улучшена корректировка рабочего дня: время прихода с обеда и ухода домой можно внести позднее в правильной последовательности.<br></h5>";
    echo "<h5 class=\"dark1\">4. Работа вне офиса корректно учитывается во временном отчете, в том числе при внесении диапазона дат и при переходе времени на следующие сутки.<br></h5>";
    echo "<h5 class=\"dark1\">5. Работа вне офиса, опоздания и приостановки выводятся за текущий квартал.<br></h5>";
    echo "<h5 class=\"dark1\">6. Улучшена вкладка отсутствия сотрудников: выгрузка архива в формате Excel.<br></h5>";
    echo "<h5 class=\"dark1\">7. Обновлены журналы и окна ввода: таблицы и прокрутка адаптируются к количеству записей и размеру рабочего окна.<br></h5>";
    echo "</div>";
    echo "</td>";
