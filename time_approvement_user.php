    ...
    echo "<tr>";
      ...
      if ( count( $addTimeInfo ) == 0 ){
        echo "<table id=\"add_time_approvement_table\" class=\"notification-detail-header-table notification-detail-empty-header\">";
          echo "<tr>";
            echo "<td class=\"notification-detail-title-cell notification-detail-title-wide\"><h5 class=\"bigbig17\">" . html_escape($userName) . "</h5><h5 class=\"big\">Период " . html_escape($periodLabel) . "</h5><br></td>";
