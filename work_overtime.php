...
<?php 
echo "<div class=\"overtime-page-layout\">";
echo "<table class=\"overtime-page-table\">";
echo "<tr>";
echo "<td class=\"overtime-nav-cell\">";
include_once __DIR__ . "/navigate.php";
echo "</td>";

echo "<td class=\"overtime-content-cell\">";
echo "<h5 class=\"dark\"><br>/Выгрузка сотрудников по переработкам<br></h5>";
?>

<div class="search_block">
    <label for="hours_input" class="overtime-filter-label">Минимум часов (с учетом обеда)</label>
    <input type="number" id="hours_input" min="0" step="1" value="9">

    <label for="period_select" class="overtime-filter-label overtime-period-label">Период</label>
    ...
    <div id="custom_range_block" class="overtime-custom-range">
        <label for="custom_start" class="overtime-filter-label">С:</label>
        <input type="date" id="custom_start" class="overtime-custom-start">
        <label for="custom_end" class="overtime-filter-label">По:</label>
...
<div id="modal_details">
    <div class="overtime-modal-header">
        <div id="modal_title" class="overtime-modal-title">Сотрудник: </div>
        <button id="modal_close" class="btn btn-danger" title="Закрыть">X</button>
    </div>
    <table id="details_table" class="overtime-details-table">
        <thead>
            <tr>
                <th>Дата</th>
                <th>Кол-во часов</th>
                <th>Работа вне офиса</th>
            </tr>
        </thead>
        <tbody></tbody>
    </table>
